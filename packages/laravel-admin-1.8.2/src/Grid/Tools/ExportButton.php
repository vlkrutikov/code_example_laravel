...
<div class="btn-group pull-right" style="margin-right: 10px">
    <a href="{$this->grid->getExportUrl('all')}" target="_blank" class="btn btn-sm btn-primary" title="{$trans['export']}"><i class="fa fa-download"></i><span class="hidden-xs"> {$trans['export']}</span></a>
